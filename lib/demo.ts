...
export const devices = [
  { 
    type: "Server", 
    name: "SRV-HQ-01", 
    serial: "SRV-HQ-01-9FK2", 
    os: "Windows Server 2022", 
    version: "20348.2402", 
    location: { name: "HQ Frankfurt", lat: 50.1109, lng: 8.6821 }, 
    room: "R-204", 
    lastLogin: "svc-backup • 2025-08-13 23:10", 
    status: "Online",
    user: "svc-backup",
    edrStatus: "active" as const,
    complianceStatus: "compliant" as const,
    health: { cpu: 45, ram: 62, storage: 78 },
    alerts: []
  },
  { 
    type: "PC", 
    name: "PC-ACC-07", 
    serial: "PC-ACC-07-X1A9", 
    os: "Windows 10 22H2", 
    version: "19045.4651", 
    location: { name: "NYC Office", lat: 40.7128, lng: -74.0060 }, 
    room: "3-112", 
    lastLogin: "mary.l • 2025-08-14 05:31", 
    status: "Online",
    user: "Mary L.",
    edrStatus: "active" as const,
    complianceStatus: "compliant" as const,
    health: { cpu: 23, ram: 41, storage: 65 },
    alerts: []
  },
  { 
    type: "Laptop", 
    ...
    location: { name: "Austin Office", lat: 30.2672, lng: -97.7431 }, 
    room: "2-Open", 
    lastLogin: "jim.s • 2025-08-14 06:57", 
    status: "Quarantined",
    user: "Jim S.",
    edrStatus: "inactive" as const,
    complianceStatus: "non-compliant" as const,
    health: { cpu: 89, ram: 94, storage: 92 },
    alerts: [
      { id: "AL-39244", title: "Endpoint EDR quarantine", severity: "high", time: "2025-08-14T05:41:00Z" },
      { id: "AL-39243", title: "Suspicious network activity", severity: "medium", time: "2025-08-14T05:35:00Z" }
    ]
  },
  { 
    type: "Phone", 
    name: "IPH-OPS-04", 
    serial: "IPH-OPS-04-77B2", 
    os: "iOS 17.5", 
    version: "21F79", 
    location: { name: "Seattle Office", lat: 47.6062, lng: -122.3321 }, 
    room: "N/A", 
    lastLogin: "tom.c • 2025-08-13 21:04", 
    status: "Offline",
    user: "Tom C.",
    edrStatus: "inactive" as const,
    complianceStatus: "non-compliant" as const,
    health: { cpu: 0, ram: 0, storage: 85 },
    alerts: [
      { id: "AL-39242", title: "Device offline for 12+ hours", severity: "medium", time: "2025-08-14T09:00:00Z" }
    ]
  },
  { 
    type: "Server", 
    name: "SRV-HQ-02", 
    serial: "SRV-HQ-02-3M7K", 
    os: "Windows Server 2022", 
    version: "20348.2402", 
    location: { name: "HQ Frankfurt", lat: 50.1109, lng: 8.6821 }, 
    room: "R-205", 
    lastLogin: "svc-web • 2025-08-13 22:45", 
    status: "Online",
    user: "svc-web",
    edrStatus: "active" as const,
    complianceStatus: "compliant" as const,
    health: { cpu: 38, ram: 55, storage: 71 },
    alerts: []
  },
  { 
    type: "PC", 
    name: "PC-ACC-08", 
    serial: "PC-ACC-08-Y2B0", 
    os: "Windows 10 22H2", 
    version: "19045.4651", 
    location: { name: "NYC Office", lat: 40.7128, lng: -74.0060 }, 
    room: "3-113", 
    lastLogin: "john.d • 2025-08-14 07:15", 
    status: "Online",
    user: "John D.",
    edrStatus: "active" as const,
    complianceStatus: "compliant" as const,
    health: { cpu: 31, ram: 48, storage: 59 },
    alerts: []
  },
  { 
    type: "Laptop", 
    ...
    location: { name: "Austin Office", lat: 30.2672, lng: -97.7431 }, 
    room: "2-Open", 
    lastLogin: "sarah.m • 2025-08-14 08:22", 
    status: "Online",
    user: "Sarah M.",
    edrStatus: "active" as const,
    complianceStatus: "compliant" as const,
    health: { cpu: 27, ram: 44, storage: 52 },
    alerts: []
  },
  { 
    type: "Phone", 
    name: "IPH-OPS-05", 
    serial: "IPH-OPS-05-88C3", 
    os: "iOS 17.5", 
    version: "21F79", 
    location: { name: "Seattle Office", lat: 47.6062, lng: -122.3321 }, 
    room: "N/A", 
    lastLogin: "lisa.r • 2025-08-14 06:30", 
    status: "Online",
    user: "Lisa R.",
    edrStatus: "active" as const,
    complianceStatus: "compliant" as const,
    health: { cpu: 12, ram: 28, storage: 73 },
    alerts: []
  },
  // Additional devices with basic info (for demo purposes)
